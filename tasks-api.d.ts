...
export declare class ListItem {
     ...
     */
    private get rawLinksInFileBody();
    /**
...
declare class Recurrence {
    ...
    private nextReferenceDate;
    private nextReferenceDateFromToday;
    private nextReferenceDateFromOriginalReferenceDate;
    /**
     ...
     */
    private static isSkippingTooManyMonths;
    /**
     ...
     */
    private static isSkippingTooManyYears;
    /**
     ...
     */
    private static fromOneDayEarlier;
    private static addTimezone;
}
...
export declare class Task extends ListItem {
    ...
    private putRecurrenceInUsersOrder;
    /**
...
declare class TaskLocation {
    private readonly _tasksFile;
    private readonly _lineNumber;
    private readonly _sectionStart;
    private readonly _sectionIndex;
    private readonly _precedingHeader;
    constructor(
        tasksFile: TasksFile,
        lineNumber: number,
        sectionStart: number,
...
export declare class TasksDate {
    ...
    private fromNowOrder;
    private fromNowStartDateOfGroup;
